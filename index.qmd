...
**Model:** `google/medgemma-4b-it` (frozen SigLIP vision encoder + Gemma 3 4B decoder) fine-tuned with QLoRA (rank 16, NF4 4-bit, target: `{q,k,v,o}_proj`) on the Indiana University Chest X-Ray dataset (3,337 usable studies: 2,403 train / 334 val / 600 test, after filtering 514 studies with empty findings). An ESS-based `WeightedRandomSampler` oversamples rare-label studies to counteract severe class imbalance (38.7% "No Finding", 9 of 14 labels below 5% prevalence).
